...
Handlebars.registerHelper('status', (status, id) => {
    ...
    switch (status) {
        case 'running':
            safeString = '<i class="fas fa-spinner fa-pulse"></i><button pid="' + id + '" name="stop_project">' +
        ...
        case 'done':
            safeString = '<i class="fas fa-check" style="color:green"></i>' +
                '<button pid="' + id + '" name="remove_project"><i class="fas fa-trash-alt"></i></button>'
            return new Handlebars.SafeString(safeString)

        case 'failed':
            safeString = '<i class="fas fa-exclamation" style="color:red"></i>' +
                '<button pid="' + id + '" name="remove_project"><i class="fas fa-trash-alt"></i></button>'
            return new Handlebars.SafeString(safeString)
